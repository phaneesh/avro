...
public class TestReflectData {
  ...
  public void testSchemaNamer() {
    SchemaNamer schemaNamer = new SchemaNamer("prefix1", "org.apache", "java.");
    ...
    record.put("id", 123);
    Schema namesSchema = new Schema.Parser()
      .parse("{\"type\":\"array\",\"items\":\"string\",\"java-class\":\"java.util.List\"}");
